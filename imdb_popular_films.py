...
def get_popular_film_list():
	...
	driver.find_element_by_xpath('//*[@id="rso"]/div[1]/div/div/table/tbody/tr[3]/td[1]/div/span/h3/a').click()
	sleep(1)
	...
	for td1,td2 in zip(table.find_all('td',class_='titleColumn'),table.find_all('td',class_='ratingColumn imdbRating')):
		...
		new_film.link='https://www.imdb.com'+a['href']
...
# def get_popular_film_poster(film_list):
...
writer=csv.writer(open('Popular_Films.csv', 'w'))
writer.writerow(['Rank','Title','Year','Rating','URL'])

film_list=get_popular_film_list()
...
#get_popular_film_poster(film_list)
